...
class CStrip(sns.Nonlinear_System):
    ...
    def __init__(self,l=2.,e=0.1, path_sym = 0, refinedefault = 0,n=10):
        ...
        self.cstrip = d2c.compstripProblem(l_in = l,e_in = e,nu_in=0.3,mu0_in=0.1,kappa_in=0, refine_in= refinedefault,n_in=n)
