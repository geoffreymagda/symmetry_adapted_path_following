...
class CStrip(sns.Nonlinear_System):
    ...
    def __init__(self,l=2.,e=0.1, path_sym = 3, refinedefault = 0,n=10,n2=4,joint_lenght=0.2,R=0.4):
        ...
        self.cstrip = d2c.compstripProblem(l_in = l,e_in = e,R_in = R,joint_lenght_in = joint_lenght,a_in = a,Lenght_in = Lenght,nu_in=0.3,mu0_in=0.1,kappa_in=0, n_in=n, n2_in=n2,refine=refinedefault)
